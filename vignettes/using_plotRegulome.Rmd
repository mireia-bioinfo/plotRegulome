...
```{r}
coordinates <- GRanges("chr20:22461643-22666093")
...
enh <- create_clustersRegulome(coordinates=coordinates,
                               cluster_dataset="superEnhancers",
                               path="~/data/IRB_database/")
...
comb_plot <- ggplot() + plot(enh) + plot(maps) + plot(tfs) + ylim(0.4,NA)
comb_plot
```
